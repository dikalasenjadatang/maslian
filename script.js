window.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("terminal"),
      n.addEventListener("keypress", function (i) {
        if (13 === i.keyCode && "" !== (i = n.value.trim())) {
          if (
            ((e.innerHTML +=
              "<div><span class='ownerTerminal'><b>maslian@profile</b></span>:<b>~$</b> " +
              i +
              "</div>"),
            (n.value = ""),
            "skills" === i || "s" === i)
            ...
            window.location.href = "https://github.com/dikalasenjadatang";
          else if ("discord" === i || "ds" === i)
            window.location.href =
              "https://discord.com/";
          else if ("telegram" === i || "tg" === i)
            window.location.href = "https://t.me/penyulamsajak";
          else if ("email" === i || "em" === i)
            window.location.href = "mailto:snowdenedwr@gmail.com";
          else if ("steam" === i || "st" === i)
            window.location.href = "https://steamcommunity.com/";
          else if ("instagram" === i || "ig" === i)
            window.location.href = "https://www.instagram.com/haimaslian";
            ...
            let n = [],
              ...
              l = [],
              t = [];
            fetch("https://haimaslian.medium.com/")
              .then((n) => n.json())
              .then((e) => {
  ...
  let suggestions = [
    ...
    projectCmd =
      '\n<div class="projectsDiv">\n<article\n  class="article-wrapper"\n  onclick="linkHref(\'https://github.com/dikalasenjadatang/tiktokDL/\')"\n>\n  <div class="project-info">\n    <div class="flex-pr">\n      <div class="project-title text-nowrap">TiktokDL</div>\n    </div>\n    <div class="flex-pr">\n      <p class="project-description">\n        Modular, fast CMS for <code>CS:GO</code>, <code>CS2</code> (coming soon)\n        servers.\n      </p>\n    </div>\n  </div>\n</article>\n\n<article\n  class="article-wrapper"\n  onclick="linkHref(\'https://github.com/dikalasenjadatang/meeting-video\')"\n>\n  <div class="project-info">\n    <div class="flex-pr">\n      <div class="project-title text-nowrap">Meeting<br />Video</div>\n    </div>\n    <div class="flex-pr">\n      <p class="project-description">\n        A personal website styled for UNIX terminal.\n      </p>\n    </div>\n  </div>\n</article>\n\n</div>\n',
